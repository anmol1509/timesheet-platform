  ...
  return (
    <form action={action} className="mt-4 space-y-3">
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <label className="block"><span className="mb-1 block text-xs font-medium text-muted">Month it covers</span><input type="month" name="periodMonth" defaultValue={row?.periodMonth ?? thisMonth()} className="input w-full" /></label>
