...
import { addLabourCardApplicationAction, removeLabourCardApplicationAction } from "./actions";
...
export function LabourCardHistorySection({
  employeeId,
  entries,
  stages,
  documents,
  ...
  function handleAdd() {
    ...
    startTransition(() => {
      addLabourCardApplicationAction(formData);
    });
    stageRef.current = "";
    documentRef.current = "";
  ...
  function handleRemove(entryId: string) {
    const formData = new FormData();
    formData.append("employeeId", employeeId);
    formData.append("labourCardApplicationId", entryId);
    startTransition(() => {
      removeLabourCardApplicationAction(formData);
    });
  }
